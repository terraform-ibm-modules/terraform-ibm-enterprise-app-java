...
variable "repos_git_token_secret_crn" {
  ...
  default     = null
  validation {
    condition     = var.repos_git_token_secret_crn != null ? can(regex("^crn:(.*:){3}(secrets-manager):(.*:){2}[0-9a-fA-F]{8}(?:-[0-9a-fA-F]{4}){3}-[0-9a-fA-F]{12}::$", var.repos_git_token_secret_crn)) : true
...
variable "subscription_id_secret_crn" {
  ...
  validation {
    condition     = var.subscription_id_secret_crn != null ? can(regex("^crn:(.*:){3}secrets-manager:(.*:){2}[0-9a-fA-F]{8}(?:-[0-9a-fA-F]{4}){3}-[0-9a-fA-F]{12}:secret:[0-9a-fA-F]{8}(?:-[0-9a-fA-F]{4}){3}-[0-9a-fA-F]{12}$", var.subscription_id_secret_crn)) : true
...
variable "mq_capacity_s2s_policy_target_crn" {
  ...
  default     = null
  validation {
    condition     = var.mq_capacity_s2s_policy_target_crn != null ? can(regex("^crn:(.*:){3}(mqcloud):(.*:){2}[0-9a-fA-F]{8}(?:-[0-9a-fA-F]{4}){3}-[0-9a-fA-F]{12}::$", var.mq_capacity_s2s_policy_target_crn)) : true
...
variable "db2_s2s_policy_target_crn" {
  ...
  default     = null
  validation {
    condition     = var.db2_s2s_policy_target_crn != null ? can(regex("^crn:(.*:){3}(dashdb-for-transactions):(.*:){2}[0-9a-fA-F]{8}(?:-[0-9a-fA-F]{4}){3}-[0-9a-fA-F]{12}::$", var.db2_s2s_policy_target_crn)) : true
